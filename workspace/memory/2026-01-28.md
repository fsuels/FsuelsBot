...
- [P2] Session memory search enabled — memory_search now covers raw transcripts + markdown files
- [P2] Context loss incident proved value of memory system — session memory search closes the gap
