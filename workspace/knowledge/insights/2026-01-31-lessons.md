...
## Lesson 1: PowerShell JSON Serialization Can Corrupt Files (CRITICAL)
...
**Second occurrence:** Same night, extraction attempt went from 1MB to 3MB
**Fix:** Restored from git both times
**Prevention:** 
- **NEVER use PowerShell ConvertTo-Json for complex objects**
- Use Node.js for JSON manipulation: `node -e "..."`
- Monitor file sizes AFTER every JSON write
- Always have recent git commits as safety net
- If file grows unexpectedly, restore immediately
...
**Failure:** 3+ seconds overhead from PS startup × 4
