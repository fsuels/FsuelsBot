...
*Learned: 2026-01-28*
*Source: memory/2026-01-28.md â€” production incidents*
...
## Evidence
- Sessions exceeding ~118K tokens trigger API timeouts â†’ `TypeError: fetch failed` â†’ process crash [verified: 2026-01-28]
...
## Application
1. **Keep sessions compact** â€” avoid loading excessive context
...
4. **Close unnecessary browser tabs** â€” keep under ~15 active tabs
5. **Use sub-agents** for heavy work â€” isolates context and prevents main session bloat
