...
- `/task show|list|set|active|paused|completed|archived|done` (manage task context and lifecycle)
- `/pin list|remove|fact|preference|constraint|temporary ...` (typed durable pins; supports `--task`, `--ttl`, `--entity`)
