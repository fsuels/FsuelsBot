...
import { TASK_BOARD_RELATIVE_PATH } from "./task-board.js";
import { normalizeTaskReadiness } from "./task-readiness.js";
...
function resolveBlockerTexts(task: RawTaskBoardTask): string[] {
  return normalizeTaskReadiness(task).unresolvedBlockers;
}
