...
import {
  ...
  type ExecApprovalWaitDecisionParams,
  ExecApprovalWaitDecisionParamsSchema,
  ErrorCodes,
  type ErrorShape,
  ErrorShapeSchema,
  type EventFrame,
...
export const validateExecApprovalWaitDecisionParams = ajv.compile<ExecApprovalWaitDecisionParams>(
  ExecApprovalWaitDecisionParamsSchema,
);
