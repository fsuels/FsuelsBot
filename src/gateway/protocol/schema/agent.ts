      ...
      Type.Object(
        {
          ...
          modelApi: Type.Optional(Type.Union([Type.String(), Type.Null()])),
          wasPostCompaction: Type.Optional(Type.Boolean()),
          systemJson: Type.Optional(Type.String()),
          messagesJson: Type.String(),
          prefixHash: NonEmptyString,
        },
        { additionalProperties: false },
      ),
    ),
